package com.thomascook.judge.slack;
...
@JBot
@Profile("slack")
public class JudgeBot extends Bot {

    private static final Logger logger = LoggerFactory.getLogger(JudgeBot.class);
    ...
    public void onReceiveDM(WebSocketSession session, Event event) {
        reply(session, event, "Hi, I am " + slackService.getCurrentUser().getName() + ", I am the law!");
    }
    ...
    /**
     * This method will be invoked after {@link JudgeBot#setupMeeting(WebSocketSession, Event)}.
     *
     * @param session
     * @param event
     */
    ...
    /**
     * This method will be invoked after {@link JudgeBot#confirmTiming(WebSocketSession, Event)}.
     *
     * @param session
     * @param event
     */
    ...
    /**
     * This method will be invoked after {@link JudgeBot#askTimeForMeeting(WebSocketSession, Event)}.
     *
     * @param session
     * @param event
     */
